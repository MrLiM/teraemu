...
public class Session {
    ...
    private void init(boolean crypted) {
        if (crypted && _decrypt) {
            try {
                Class<?> clazz = Class.forName("com.angelis.tera.packet.crypt." + _protocol.getEncryption() + "Crypter");
    ...
    public void addPacket(byte[] data, boolean fromServer, long time) {
        PacketDirectionEnum direction = (fromServer ? PacketDirectionEnum.SERVER : PacketDirectionEnum.CLIENT);
