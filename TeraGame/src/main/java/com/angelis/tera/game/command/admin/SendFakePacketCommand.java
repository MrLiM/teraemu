...
public class SendFakePacketCommand extends AbstractAdminCommand {
    ...
    public void execute(TeraGameConnection connection, String[] arguments) {
        ...
        // ChatTypeEnum.SOCIAL));
        connection.sendPacket(new SM_OPCODE_LESS_PACKET("067D0100410000000000AFA4000000800C0001000000F8030000D500000000000000010000000F5C63000000000000010000000000000000000000FFFFFFFF410000004F00010000002400000040006E00700063003A00310032000000"));
    }
