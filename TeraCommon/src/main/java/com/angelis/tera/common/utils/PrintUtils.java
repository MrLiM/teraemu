...
public class PrintUtils {
    ...
    public static ByteBuffer combineByteBuffer(ByteBuffer original, ByteBuffer... buffers) {
        int size = original.limit();
        for (ByteBuffer buffer : buffers) {
            size += buffer.limit();
        }
        
        ByteBuffer returnBuffer = ByteBuffer.allocate(size);
        returnBuffer.put(original);
        for (ByteBuffer buffer : buffers) {
            returnBuffer.put(buffer);
        }
